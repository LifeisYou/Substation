...
import com.xczn.substation.fragment.DemoFragment;
...
public class MenuBean {
    ...
    public static List<MenuBean> getMenuList() {
        ...
        list.add(new MenuBean("我的报警", R.drawable.ic_menu_alarm_64, DemoFragment.newInstance()));
        list.add(new MenuBean("历史报表", R.drawable.ic_menu_chart_64, DemoFragment.newInstance()));
        list.add(new MenuBean("历史报警", R.drawable.ic_menu_alarm_64, DemoFragment.newInstance()));
        list.add(new MenuBean("服务器", R.drawable.ic_menu_server_64, ServerFragment.newInstance()));
        list.add(new MenuBean("订阅报警", R.drawable.ic_menu_subscribe_64, DemoFragment.newInstance()));
